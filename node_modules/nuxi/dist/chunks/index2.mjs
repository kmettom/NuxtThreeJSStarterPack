import { a as withoutTrailingSlash, g as getQuery$1, b as withoutBase } from '../shared/nuxi.0f96560f.mjs';
...
const stringToBuffer = (value) => {
  return new TextEncoder().encode(value);
};
const bufferToString = (value) => {
  return new TextDecoder().decode(value);
};
const base64urlEncode = (value) => toBase64(value instanceof Uint8Array ? value : stringToBuffer(value)).replace(/\+/g, "-").replace(/\//g, "_").replace(/=/g, "");
const base64urlDecode = (value) => fromBase64(
